...
class UserForm extends StatefulWidget {
  ...
  UserForm( {Key? key, required this.id, required this.nom,
    ...
    required this.role, required this.photo, required this.superviseur_id,required this.accessToken, required this.typecompte, required this.nomfil, required this.nom_user, required this.photo_user, required this.salle,}) : super(key: key);
...
class _UserFormState extends State<UserForm> {
 ...
 // int? fetchedId;
  ...
  void initState() {
    ...
    fetchDepartements().then((salles) {
      setState(() {
        ...
        if (widget.typecompte != '' && widget.salle!='') {
          selectedOption2 = widget.typecompte;
          selectedOption = widget.salle;
        } else {
          selectedOption2 = compteList.isNotEmpty ? compteList[0] : null;
          selectedOption = salleList.isNotEmpty ? salleList[0] : null;
        }
  ...
  Future<List<String>> fetchDepartements() async {
    ...
    var response = await http.get(Uri.parse(baseUrl+'surveillances/salles/nom'),headers: headers);
  ...
  int id,
   ...
   ,File imageFile) async {
    ...
    request.fields['role'] = 'surveillant';
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? newValue) async {
                                  ...
                                  if (selectedOption2 != null) {
                                    ...
                                    _selectedcomplete = compteList.indexOf(newValue);
                                  }
                                },
                              ...
                              child: DropdownButton<String>(
                                ...
                                onChanged: (String? newValue) async {
                                  ...
                                  if (selectedOption != null) {
                                    ...
                                    _selectedsuperviseur = compteList.indexOf(newValue!);
                                  }
                                },
                        ...
                        onTap: () async {
                          await QuickAlert.show(
                            ...
                            if (value == null) {
                              ...
                              int? idSup = salleList.indexOf(selectedOption ?? "");
