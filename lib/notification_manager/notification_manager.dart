...
class NotificationManager {
  ...
  Future<void> simpleNotificationShow(String content) async {
    ...
    await notificationsPlugin.show(
        0, content, 'New Surveillant send message', notificationDetails);
  }

  Future<void> bigPictureNotificationShow(String content) async {
    ...
    NotificationDetails notificationDetails =
        NotificationDetails(android: androidNotificationDetails);
    await notificationsPlugin.show(
        1, 'New Notification', content, notificationDetails);
  }
