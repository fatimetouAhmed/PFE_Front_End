...
class MasterPage2 extends StatefulWidget {
  ...
  String nom_user;
  String photo_user;
  MasterPage2({required this.child, required this.index,required this.accessToken, required this.nomfil,required this.nom_user,required this.photo_user});

  @override
  _MasterPageState createState() => _MasterPageState();
}

class _MasterPageState extends State<MasterPage2> {
